...
$jam_sources = [
	"item" => [
		...
		"modules" => [
			...
			"post" => [
				"name" => "Post itemtype",
				"description" => "The simplest content item for posts.",
				"info_link" => "https://github.com/parentnode/jam-item-post-simplest",
				"repos" => "http://jam-item-post-simplest.local",
				// "repos" => "https://github.com/parentnode/jam-item-post-simplest",
			],
			"event" => [
				"name" => "Event itemtype",
				"description" => "The simplest content item for events.",
				"info_link" => "https://github.com/parentnode/jam-item-event-simplest",
				"repos" => "http://jam-item-event-simplest.local",
				// "repos" => "https://github.com/parentnode/jam-item-event-simplest",
			],
			"service" => [
				...
				"repos" => "http://jam-item-service-simplest.local",
				// "repos" => "https://github.com/parentnode/jam-item-service-simplest",
			],
			"product" => [
				"name" => "Product itemtype",
				"description" => "The simplest content item for products.",
				"info_link" => "https://github.com/parentnode/jam-item-product-simplest",
				"repos" => "http://jam-item-product-simplest.local",
				// "repos" => "https://github.com/parentnode/jam-item-product-simplest",
			],
		]
	],
	// "instantmessage" => [
