...
<div class="scene i:scene">
	...
	<?= $model->formStart("/janitor/admin/setup/upgrade/replaceEmails", array("class" => "labelstyle:inject i:replace_emails")) ?>
		<fieldset>
			...
			<?= $model->input("exclude", array("label" => "Exclude email address(es)", "type" => "string", "hint_message" => "You may want to exclude some email adresses from being replaced, e.g. the developers. Separate email addresses with commas.", "value" => defined(ADMIN_EMAIL) ? ADMIN_EMAIL : "")) ?>
