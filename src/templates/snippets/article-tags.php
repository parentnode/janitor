...
<?
	if($editing_tag):
?>
		<li class="editing" title="<?= $editing_text ?>"><?= ($editing_tag["value"] == "true" ? $editing_text : $editing_tag["value"]) ?></li>
<?
	endif;
...
<?			if($url): ?>
			<a href="<?= $url ?>/<?= urlencode($item_tag["value"]) ?>">
<?			endif; ?>
				<?= $item_tag["value"] ?>
<?			if($url): ?>
			</a>
