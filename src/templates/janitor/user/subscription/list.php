		...
		<ul class="items subscriptions">
			...
			<li class="item subscription">
				...
				<dl class="info">
					...
					<dd class="created_at"><?= $subscription["created_at"] ?></dd>

				<? if($subscription["renewed_at"]): ?>
					<dt class="renewed_at">Last renewed at</dt>
					<dd class="renewed_at"><?= $subscription["renewed_at"] ?></dd>
				<? endif; ?>

				<? if($subscription["expires_at"]): ?>
					<dt class="expires_at">Expires at</dt>
					<dd class="expires_at"><?= $subscription["expires_at"] ?></dd>
				<? endif; ?>
				...
				<? if($subscription["item"]["prices"]): ?>
					...
					<dd class="payment_method"><?= $subscription["payment_method"] ? $subscription["payment_method"]["name"] : "MISSING" ?></dd>
