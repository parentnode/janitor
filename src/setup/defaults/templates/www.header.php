...
<? if(session()->value("dev")) { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/lib/seg_<?= $this->segment(array("type" => "janitor")) ?>_include.css" />
	<script type="text/javascript" src="/js/lib/seg_<?= $this->segment(array("type" => "janitor")) ?>_include.js"></script>
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment(array("type" => "janitor")) ?>.css" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment(array("type" => "janitor")) ?>.js"></script>
<? } ?>
</head>
