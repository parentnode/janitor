...
//					unlink(LOCAL_PATH."/config/httpd-vhosts.template.conf");
			...
			// If template exists, use that
				...
				$file_config = preg_replace("/###SITE_SIGNUP###/", $this->get("config", "site_signup"), $file_config);
				$file_config = preg_replace("/###SITE_ITEMS###/", $this->get("config", "site_items"), $file_config);
				$file_config = preg_replace("/###SITE_SHOP###/", $this->get("config", "site_shop"), $file_config);
				$file_config = preg_replace("/###SITE_SUBSCRIPTIONS###/", $this->get("config", "site_subscriptions"), $file_config);
				$file_config = preg_replace("/###SITE_MEMBERS###/", $this->get("config", "site_members"), $file_config);
			...
			$query->updateDbVersion($UP->current_janitor_version);
