...
document.write('<script type="text/javascript" src="/janitor/admin/js/lib/desktop/m-login.js"></script>');


document.write('<script type="text/javascript" src="/janitor/admin/js/lib/desktop/m-default_list.js"></script>');
